...
# the motion controller is to be put here
...
def main():
    ...
    time = 0.0
    # basically the obstacle locations to be fed into the RFID array
    # RFID positions [x, y]
    RFID = np.array([[5.0, 13.0],
                     [15.0, 10.0],
                     [15.0, 15.0],
                     [10.0, 20.0],
                     [3.0, 15.0],
